...
<div class="space-y-6 max-w-4xl mx-auto">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <h1 class="text-2xl font-bold text-slate-900 tracking-tight">Tulis Berita Sekolah Baru</h1>
        </div>
    ...
    <form action="{{ route('admin.berita.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="bg-white rounded-2xl border border-slate-200/80 p-5 sm:p-6 shadow-sm space-y-5">
            ...
            <div>
                ...
                <input type="text" name="title" id="title" value="{{ old('title') }}" required placeholder="Contoh: Tim Robotik SMKN 1 CIOMAS Juara 1 Nasional di ITB Bandung" class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition-all">
            ...
            <div>
                <label class="block text-sm font-semibold text-slate-800 mb-1.5">
                    Foto Utama / Thumbnail Artikel <span class="text-xs text-slate-400 font-normal">(Opsional, Maks. 3MB)</span>
                </label>
